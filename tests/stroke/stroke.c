 ...
 * Format: VG_LITE_BGRA8888 (Vulkan-native; official CTS uses RGB565)
 ...
 *
 * Ported from VGLite_Tests/VSI_CTS/samples/stroke/stroke.c.
 * Adaptations for vglite_vulkan_2026: util.h/Common.h macros, BGRA8888 format,
 * snprintf, float literals, error-aware return value. Path data and stroke
 * attributes (including color=0 and bbox=0,0,0,0) are preserved exactly as
 * the official CTS source to match reference behavior.
 */
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
