...
extern int vg_lite_verify_raw(vg_lite_buffer_t *actual, const char *golden_path, int tolerance);
...
int main(int argc, const char * argv[])
{
    ...
    {
        int fail = vg_lite_verify_raw(fb, golden, 100);
        printf("vector golden: %s (%d mismatches)\n", fail == 0 ? "PASS" : "FAIL", fail);
    }
